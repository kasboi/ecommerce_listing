...
//   const product = getProductById(paramsId);

//   if (!product) {
//     return {
//       title: "Product Not Found - GidiStore",
//       description: "The requested product could not be found.",
//     };
//   }

//   return {
//     title: `${product.name} - GidiStore`,
//     description: product.description,
//     keywords: `${product.category}, ${product.name}, ecommerce, shopping`,
//     openGraph: {
//       title: product.name,
//       description: product.description,
...
export default function ProductPage({ paramsId }: { paramsId: string }) {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      const productData = getProductById(paramsId);
      if (!productData) {
        notFound();
      }
      setProduct(productData);

      const productReviews = getReviewsByProductId(paramsId);
  ...
  const handleSubmitReview = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updatedProduct = getProductById(paramsId);
      if (updatedProduct) {
